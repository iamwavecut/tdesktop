...
int WelcomeMessagesWidget::cornerButtonsUnreadCount() {
	return 0;
}
...
void WelcomeMessagesWidget::cornerButtonsSummarizeDown() {
}

bool WelcomeMessagesWidget::cornerButtonsSummarizeDownActive() {
	return false;
}

bool WelcomeMessagesWidget::cornerButtonsSummarizeDownLoading() {
	return false;
}
